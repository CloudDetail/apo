...
var enText = map[string]string{
	...
	ClearIncidentTempBySourceError:    "Failed to clear incident group rule by source",
	SetIncidentTempBySourceError:      "Failed to set incident group rule by source",
	GetIncidentTempBySourceError:      "Failed to get incident group rule by source",
