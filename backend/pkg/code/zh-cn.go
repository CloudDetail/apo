...
var zhCnText = map[string]string{
	...
	ClearIncidentTempBySourceError:    "清空告警源告警聚合规则失败",
	SetIncidentTempBySourceError:      "设置告警源告警聚合规则失败",
	GetIncidentTempBySourceError:      "获取告警源告警聚合规则失败",
