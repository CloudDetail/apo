...
func (repo *daoRepo) GetRoles(ctx_core core.Context, filter model.RoleFilter) ([]Role, error) {
	var roles []Role
...
func (repo *daoRepo) GetUserRole(ctx_core core.Context, userID int64) ([]UserRole, error) {
...
func (repo *daoRepo) GetUsersRole(ctx_core core.Context, userIDs []int64) ([]UserRole, error) {
	var userRoles []UserRole
	err := repo.db.Where("user_id in ?", userIDs).Find(&userRoles).Error
	return userRoles, err
}

func (repo *daoRepo) RoleGrantedToUser(ctx_core core.Context, userID int64, roleID int) (bool, error) {
	var count int64
...
func (repo *daoRepo) GrantRoleWithUser(ctx_core core.Context, ctx context.Context, userID int64, roleIDs []int) error {
	if len(roleIDs) == 0 {
		return nil
	}
...
func (repo *daoRepo) RoleExists(ctx_core core.Context, roleID int) (bool, error) {
	var count int64
...
func (repo *daoRepo) UpdateRole(ctx_core core.Context, ctx context.Context, roleID int, roleName, description string) error {
	role := Role{
		RoleID:		roleID,
		RoleName:	roleName,
...
func (repo *daoRepo) RoleGranted(ctx_core core.Context, roleID int) (bool, error) {
	var count int64
