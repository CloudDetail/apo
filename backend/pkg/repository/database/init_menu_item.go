...
func (repo *daoRepo) initMenuItems() error {
	menuItemsMapping := []struct {
		...
		{MenuItem: MenuItem{Key: "dataIntegration", Order: 21}, RouterKey: "/integration/data"},
		{MenuItem: MenuItem{Key: "alertsIntegration", Order: 22}, RouterKey: "/integration/alerts"},
		...
		{MenuItem: MenuItem{Key: "team", Order: 35}, RouterKey: "/system/team"},
	}
