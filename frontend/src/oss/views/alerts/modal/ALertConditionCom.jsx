...
export default function ALertConditionCom({ expr, setExpr }) {
  ...
  return (
    <>
      <div className="flex border-1 border-solid rounded border-[var(--ant-color-border-secondary)] hover:border-[--ant-color-primary-border-hover] focus:border-[var(--ant-color-primary-border)]">
