...
import { convertTime, splitTimeRange, TimestampToISO } from 'src/core/utils/time'
import './index.css'
...
const Timeline = (props) => {
  ...
  const { type, startTime, endTime, instance, pid, nodeName, containerId, service, endpoint } =
    props
  ...
  }, [activeKey, chronoList, type, service, endpoint, instance])
